...
4. Add the references to text, where the reference for `ggmice` should take the form: Hanne Oberman [-@ggmice] and the reference for the others should take the form (Author, Year). 
